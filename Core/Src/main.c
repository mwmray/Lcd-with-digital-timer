...
int main(void) {
	...
	/* USER CODE BEGIN 2 */
	Alcd_Init(&lcd1, 2, 16);
//	Alcd_PutAt(&lcd1, 1, 0, "Michael");
//	Alcd_PutAt_n(&lcd1, 0, 0, "Michael metri", Str_Len("Michael Wafik"));
//
//	//TO DISPLAY TIME DATA IN FORM OF HH:MM:SS
//	HH = 12;
//	MM = 33;
//	SS = 1;
//
//	uint8_t length = sprintf(str, "%02d:%02d:%02d", HH, MM, SS); //ZERO IS PADDNG AND 2 IS NUMBER OF ZEROS
//
